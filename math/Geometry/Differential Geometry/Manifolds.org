...
:ROAM_ALIASES: "manifold" "locally euclidean" "atlas" "chart" "smooth manifold" "smooth structure"
:END:
#+title: Manifolds
#+SETUPFILE: ../../../setup.org
...
** Manifold
A manifold is a topological spacer \((M, \tau)\) that satisfies three properties: 1. \(M\) is a [[id:14F2DB4F-672A-42CD-B683-BE90B7E3F5C9][Hausdorff space]] 2. \(M\) is a [[Basis (topology).org][second-countable space]] 3. \(M\) is locally Euclidean of dimension \(n\)
